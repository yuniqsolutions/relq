...
export interface SqlDialect {
	...
	explain(query: string, options: ExplainOptions): string;
...
declare class ConnectedAggregateBuilder<TTable = any, TResult = {}, TSchema = any> {
	private builder;
	private relq;
	private tableName;
	...
	where(callback: (builder: TypedConditionBuilder<TTable, TSchema>) => TypedConditionBuilder<TTable, TSchema>): this;
...
/**
 * Flatten a type for better IDE display.
 * Forces TypeScript to expand Pick/Omit into their resolved form.
 */
...
export type PickColumns<T, K extends string> = T extends {
	$inferSelect: infer TSelect;
} ? Prettify<Pick<TSelect, K & keyof TSelect>> : Prettify<Pick<T, K & keyof T>>;
/**
...
/**
 * TableAccessor type - property-based table access
 * Usage: db.table.users, db.table.orders, etc.
 */
export type TableAccessor<TSchema, TRelq> = {
	-readonly [K in keyof TSchema & string]: ConnectedQueryBuilder<TSchema, TSchema[K]>;
};
declare class SqlExpression<T = any> {
...
declare class AggregateFunctions {
	 ...
	 * ```
	 */
	count(ref?: ColumnRef): SqlExpression<number>;
	/**
	 ...
	 * ```
	 */
	countDistinct(ref: ColumnRef): SqlExpression<number>;
	/**
	 ...
	 * ```
	 */
	sum(ref: ColumnRef): SqlExpression<number>;
	/**
	 ...
	 * ```
	 */
	avg(ref: ColumnRef): SqlExpression<number>;
	/**
	 ...
	 * ```
	 */
	min<T>(ref: ColumnRef<any, string, T>): SqlExpression<T>;
	/**
	 ...
	 * ```
	 */
	max<T>(ref: ColumnRef<any, string, T>): SqlExpression<T>;
	/**
	 ...
	 * ```
	 */
	raw<T = any>(sql: string): SqlExpression<T>;
}
type Prettify$1<T> = {
	[K in keyof T]: T[K];
} & {};
 ...
 * ```
 */
export type InferIncludeResult<T extends Record<string, SqlExpression<any>>> = {
	[K in keyof T]: T[K] extends SqlExpression<infer U> ? U : any;
};
declare class ConnectedSelectBuilder<TSchema = any, TTable = any, TColumns extends readonly any[] = any, TJoined = {}> {
	 ...
	 */
	private coerceValue;
	where(callback: (q: TypedConditionBuilder<TTable, TSchema>) => TypedConditionBuilder<TTable, TSchema>): this;
	orderBy(column: ColumnName<TTable>, direction?: "ASC" | "DESC"): this;
	/**
	 * Order by with explicit NULLS FIRST or NULLS LAST placement.
	 * PostgreSQL-specific ordering control for NULL values.
	 ...
	 * ```
	 */
	include<TInclude extends Record<string, SqlExpression<any>>>(callback: (a: AggregateFunctions, t: {
...
declare class ConnectedUpdateBuilder<TTable = any, TSchema = any> {
	private builder;
	private relq;
	private tableName?;
	private schemaKey?;
	...
	returning<K extends string & ColumnName<TTable>>(columns: K | K[]): ReturningExecutor<Prettify$2<Pick<TTable extends {
		$inferSelect: infer S;
	} ? S : TTable, K & keyof (TTable extends {
		$inferSelect: infer S;
	} ? S : TTable)>>>;
	returning<K extends string & ColumnName<TTable>>(columns: K[] | null): this | ReturningExecutor<Prettify$2<Pick<TTable extends {
		$inferSelect: infer S;
	} ? S : TTable, K & keyof (TTable extends {
		$inferSelect: infer S;
	} ? S : TTable)>>>;
...
declare class ConnectedDeleteBuilder<TTable = any, TSchema = any> {
	private builder;
	private relq;
	private tableName?;
	private schemaKey?;
...
export interface SqlHelpers {
	 ...
	 */
	increment(amount: number | bigint): SqlExpression$1;
	/**
	 * Add two values: a + b
	 */
	add(a: ColumnRef$1 | number | bigint, b: ColumnRef$1 | number | bigint): SqlExpression$1;
	/**
	 * Subtract: a - b
	 */
	subtract(a: ColumnRef$1 | number | bigint, b: ColumnRef$1 | number | bigint): SqlExpression$1;
	/**
	 * Multiply: a * b
	 */
	multiply(a: ColumnRef$1 | number | bigint, b: ColumnRef$1 | number | bigint): SqlExpression$1;
	/**
	 * Divide: a / b
	 */
	divide(a: ColumnRef$1 | number | bigint, b: ColumnRef$1 | number | bigint): SqlExpression$1;
	/**
	 * Modulo: a % b
	 */
	modulo(a: ColumnRef$1 | number | bigint, b: ColumnRef$1 | number | bigint): SqlExpression$1;
	/**
	 * COALESCE - return first non-null value
	 */
	coalesce(...values: (ColumnRef$1 | any)[]): SqlExpression$1;
	/**
	 * GREATEST - return largest value
	 */
	greatest(...values: (ColumnRef$1 | number | bigint)[]): SqlExpression$1;
	/**
	 * LEAST - return smallest value
	 */
	least(...values: (ColumnRef$1 | number | bigint)[]): SqlExpression$1;
	/**
	 * NULLIF - return NULL if a equals b
	 */
	nullif(a: ColumnRef$1 | any, b: ColumnRef$1 | any): SqlExpression$1;
	/**
	 * ABS - absolute value
	 */
	abs(value: ColumnRef$1 | number | bigint): SqlExpression$1;
	/**
	 * CEIL - ceiling
	 */
	ceil(value: ColumnRef$1 | number): SqlExpression$1;
	/**
	 * FLOOR - floor
	 */
	floor(value: ColumnRef$1 | number): SqlExpression$1;
	/**
	 * ROUND - round to nearest integer or decimal places
	 */
	round(value: ColumnRef$1 | number, decimals?: number): SqlExpression$1;
	/**
	 * CONCAT - concatenate strings
	 */
	concat(...values: (ColumnRef$1 | string)[]): SqlExpression$1;
	/**
	 * LOWER - lowercase string
	 */
	lower(value: ColumnRef$1 | string): SqlExpression$1;
	/**
	 * UPPER - uppercase string
	 */
	upper(value: ColumnRef$1 | string): SqlExpression$1;
	/**
	 * TRIM - remove leading/trailing whitespace
	 */
	trim(value: ColumnRef$1 | string): SqlExpression$1;
	/**
	 ...
	 */
	currentDate(): SqlExpression$1;
	/**
	 * CURRENT_TIMESTAMP - current timestamp with time zone
	 */
	currentTimestamp(): SqlExpression$1;
}
/**
...
declare class ConflictBuilder<TTable = any> {
	...
	private _tableName;
	private _columnResolver?;
	constructor(tableName: string);
	/**
	 * Set a column resolver for transforming property names to SQL column names.
	 * @internal
	 */
...
export declare class InsertBuilder {
	 ...
	 */
	setColumnTypeResolver(resolver: (column: string) => ColumnTypeInfo | undefined): InsertBuilder;
	/**
...
declare class ConnectedCountBuilder<TTable = any, TGroups extends Record<string, number> = {}, TSchema = any> {
	private builder;
	private relq;
	private tableName;
	private groupNames;
	 ...
	 */
	get(): Promise<keyof TGroups extends never ? number : Prettify$2<TGroups>>;
}
...
declare class TransactionClient<TSchema = any> {
	...
	/** Delegate dialect info so requireCapability works inside transactions */
	get dialect(): string;
 ...
 * ```
 */
export type InferScalars<T extends Record<string, ScalarCallback<any, any>>> = Prettify$2<{
...
declare class ConnectedQueryBuilder<TSchema = any, TTable = any> {
	...
	update(data: UpdateData<TTable>): ConnectedUpdateBuilder<TTable, TSchema>;
	/** Creates a DELETE query */
	delete(): ConnectedDeleteBuilder<TTable, TSchema>;
	/** Creates a COUNT query */
	count(): ConnectedCountBuilder<TTable, {}, TSchema>;
	/** Creates a standalone AGGREGATE query */
	aggregate(): ConnectedAggregateBuilder<TTable, {}, TSchema>;
 ...
 * ```
 */
/** Table accessor for subquery callbacks — only exposes .select() with full type inference */
export type SubqueryAccessor<TSchema> = {
	-readonly [K in keyof TSchema & string]: Pick<ConnectedQueryBuilder<TSchema, TSchema[K]>, "select">;
};
export interface TypedConditionBuilder<TTable = any, TSchema = any> {
	...
	/** Creates an IN condition for array matching or subquery callback */
	in<K extends ColumnName<TTable>>(column: K, values: ConditionValue<TTable, K>[]): TypedConditionBuilder<TTable, TSchema>;
	in<K extends ColumnName<TTable>>(column: K, subquery: (t: SubqueryAccessor<TSchema>) => {
		toString(): string;
	}): TypedConditionBuilder<TTable, TSchema>;
	/** Creates a NOT IN condition for array exclusion or subquery callback */
	notIn<K extends ColumnName<TTable>>(column: K, values: ConditionValue<TTable, K>[]): TypedConditionBuilder<TTable, TSchema>;
	notIn<K extends ColumnName<TTable>>(column: K, subquery: (t: SubqueryAccessor<TSchema>) => {
		toString(): string;
	}): TypedConditionBuilder<TTable, TSchema>;
...
type UpdateValue$1 = QueryValue | UpdateCallback;
...
export declare class UpdateBuilder {
	 ...
	 */
	setColumnTypeResolver(resolver: (column: string) => ColumnTypeInfo$1 | undefined): UpdateBuilder;
	/**
	 * Resolve a column name using the column resolver or fallback to convertColumnName.
	 * @internal
	 */
...
type InferColumnType$2<T> = T extends ColumnConfig<infer U> ? CleanValueType<U> : T;
/**
...
export type InferTableType<TColumns> = {
	[K in keyof TColumns]: InferColumnType$2<TColumns[K]>;
};
/**
...
export type UnwrapTableType<TTable> = TTable extends {
	...
	[K in keyof TCols]: InferColumnType$2<TCols[K]>;
} : TTable : TTable;
/**
...
export declare class ExplainBuilder {
	 ...
	 */
	constructor(query: string, options?: ExplainOptions$1);
	/**
...
export {
	...
	ExplainOptions$1 as ExplainOptions,
	InferColumnType$1 as InferColumnType,
	Prettify$2 as Prettify,
	Relq as RelqClient,
	relq as default,
};
