...
exports.pgDialect = exports.PgDialect = void 0;
const capabilities_1 = require("../pg-client/capabilities.cjs");
class PgDialect {
    name = 'postgres';
    ...
    supports(capability) {
        return capabilities_1.PG_CAPABILITIES[capability] === true;
    }
    transformSql(sql) {
        return sql;
    }
...
exports.pgDialect = new PgDialect();
