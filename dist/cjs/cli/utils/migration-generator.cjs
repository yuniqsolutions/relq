...
exports.generateMigrationNameFromComparison = generateMigrationNameFromComparison;
exports.formatMigrationStatements = formatMigrationStatements;
exports.formatMigrationStatementsPolished = formatMigrationStatementsPolished;
...
function generateMigrationNameFromComparison(comparison) {
    const parts = [];
...
function formatMigrationStatements(statements) {
...
function formatMigrationStatementsPolished(statements) {
    if (statements.length === 0)
        return [];
    const result = [];
