...
exports.SQLITE_VERSION_FEATURES = exports.SQLITE_ALTER_TABLE_SUPPORT = exports.POSTGRES_TO_SQLITE_TYPE_MAP = exports.SQLITE_TYPE_AFFINITY = exports.TURSO_FEATURES = exports.SQLITE_FEATURES = void 0;
exports.SQLITE_FEATURES = {
    supportsJson: true,
    supportsJsonb: false,
...
exports.POSTGRES_TO_SQLITE_TYPE_MAP = {
    'serial': 'INTEGER',
    'bigserial': 'INTEGER',
    'smallserial': 'INTEGER',
    'integer': 'INTEGER',
...
exports.SQLITE_ALTER_TABLE_SUPPORT = {
    renameTable: true,
    renameColumn: true,
    addColumn: true,
    dropColumn: true,
...
exports.SQLITE_VERSION_FEATURES = {
