...
exports.NILE_FEATURES = exports.NileAdapter = void 0;
...
class NileAdapter {
    ...
    family = 'postgres';
    displayName = 'Nile';
    features = features_1.NILE_FEATURES;
    defaultPort = 5432;
    ...
    async introspect(connection, options) {
        const config = connection;
        return (0, introspect_1.introspectNile)(config, options);
    }
    ...
    validate(schema) {
        return (0, validator_1.validateSchemaForNile)(schema);
    }
    validateTable(table) {
        const minimalSchema = {
            database: '',
        ...
        return (0, validator_1.validateSchemaForNile)(minimalSchema);
    }
    ...
    validateSql(sql, _context) {
        return (0, validator_1.validateSqlForNile)(sql);
    }
    ...
    setTenant(tenantId) {
        if (!(0, tenant_context_1.isValidUuid)(tenantId)) {
    ...
    getSetTenantSql(tenantId) {
        return (0, tenant_context_1.generateSetTenantSql)(tenantId);
    }
    getClearTenantSql() {
        return (0, tenant_context_1.generateClearTenantSql)();
    }
    getCheckTenantSql() {
        return (0, tenant_context_1.generateGetTenantSql)();
    }
}
exports.NileAdapter = NileAdapter;
var features_2 = require("./features.cjs");
Object.defineProperty(exports, "NILE_FEATURES", { enumerable: true, get: function () { return features_2.NILE_FEATURES; } });
