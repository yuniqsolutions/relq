...
var exports_pg_format = {};
__export(exports_pg_format, {
  default: () => pg_format_default
});
module.exports = __toCommonJS(exports_pg_format);
...
var buf = __toESM(require_buffer(), 1);
__reExport(exports_buffer, __toESM(require_buffer(), 1), module.exports);
var buffer_default = buf;
...
function quoteIdent(value) {
  ...
  if (value instanceof exports_buffer.Buffer) {
