...
var require_pg_cursor = __commonJS((exports2, module2) => {
...
var exports_pg_cursor = {};
__export(exports_pg_cursor, {
  default: () => pg_cursor_default
});
module.exports = __toCommonJS(exports_pg_cursor);
