...
exports.NILE_BLOCKED_LANGUAGES = exports.NILE_BLOCKED_FUNCTION_KINDS = void 0;
exports.validateNileFunction = validateNileFunction;
exports.validateNileFunctions = validateNileFunctions;
exports.NILE_BLOCKED_FUNCTION_KINDS = new Set([
    'function',
    'procedure',
    'trigger',
    'do_block',
]);
exports.NILE_BLOCKED_LANGUAGES = new Set([
    'plpgsql',
    'plpython3u',
    'plperl',
    'pltcl',
...
function validateNileFunction(input) {
    const messages = [];
...
function validateNileFunctions(inputs) {
    const messages = [];
