...
exports.validateNileSequence = validateNileSequence;
exports.validateNileSequences = validateNileSequences;
exports.validateNileSequenceExpression = validateNileSequenceExpression;
function validateNileSequence(input) {
    const messages = [];
...
function validateNileSequences(inputs) {
    const messages = [];
...
function validateNileSequenceExpression(expression, tableType) {
    const messages = [];
    if (tableType !== 'tenant') {
        return messages;
    }
