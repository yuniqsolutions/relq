...
exports.NILE_BLOCKED_MISC_FEATURES = exports.NILE_BLOCKED_ADMIN_PATTERNS = void 0;
exports.validateNileBuiltinTable = validateNileBuiltinTable;
exports.validateNileTenantIdProtection = validateNileTenantIdProtection;
exports.validateNileExtensions = validateNileExtensions;
exports.validateNileMiscSql = validateNileMiscSql;
exports.validateNileTransactionConcerns = validateNileTransactionConcerns;
const table_classifier_1 = require("./table-classifier.cjs");
exports.NILE_BLOCKED_ADMIN_PATTERNS = [
...
exports.NILE_BLOCKED_MISC_FEATURES = new Set([
    'trigger',
    'function',
    'procedure',
    'do_block',
...
function validateNileBuiltinTable(input) {
    const messages = [];
    const normalizedName = input.tableName.toLowerCase().trim();
    if (!table_classifier_1.NILE_BUILTIN_TABLE_NAMES.has(normalizedName)) {
        return messages;
    }
...
function validateNileTenantIdProtection(tableName, operation) {
...
function validateNileExtensions(sql) {
    const messages = [];
...
function validateNileMiscSql(sql) {
    const messages = [];
    const seenCodes = new Set();
    for (const entry of exports.NILE_BLOCKED_ADMIN_PATTERNS) {
...
function validateNileTransactionConcerns(hasTenantTableWrites, hasSharedTableWrites) {
    const messages = [];
