...
function pgSequence(name, options = {}) {
    const config = {
        ...
        toAST() {
            return {
                name: this.name,
                startValue: this.options.start !== undefined ? Number(this.options.start) : undefined,
                increment: this.options.increment !== undefined ? Number(this.options.increment) : undefined,
                minValue: this.options.minValue != null ? Number(this.options.minValue) : undefined,
                maxValue: this.options.maxValue != null ? Number(this.options.maxValue) : undefined,
