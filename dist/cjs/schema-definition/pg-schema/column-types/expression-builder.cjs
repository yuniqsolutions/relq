...
exports.formatGenValue = formatGenValue;
exports.chainableExpr = chainableExpr;
exports.formatFluentValue = formatFluentValue;
exports.createFluentGenExpr = createFluentGenExpr;
exports.createCaseBuilder = createCaseBuilder;
...
function formatFluentValue(val) {
    if (val === null)
        return 'NULL';
...
function createFluentGenExpr(sql) {
    const self = {
        $sql: sql,
        $expr: true,
        coalesce(fallback) {
