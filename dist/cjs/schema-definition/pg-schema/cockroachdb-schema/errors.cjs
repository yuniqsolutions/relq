...
exports.CRDB_INFO = exports.CRDB_WARNINGS = exports.CRDB_ERRORS = void 0;
...
function createValidationResult(messages) {
...
function lookupErrorCode(code) {
    return exports.CRDB_ERRORS[code]
        ?? exports.CRDB_WARNINGS[code]
        ?? exports.CRDB_INFO[code];
}
function createMessage(code, location) {
