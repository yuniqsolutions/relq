...
exports.generatePolicySQL = generatePolicySQL;
exports.dropPolicySQL = dropPolicySQL;
exports.enableRlsSQL = enableRlsSQL;
exports.forceRlsSQL = forceRlsSQL;
...
function generatePolicySQL(config) {
...
function dropPolicySQL(config, ifExists = true) {
