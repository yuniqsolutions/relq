...
exports.createCheckWhereCondition = createCheckWhereCondition;
exports.createCheckExpr = createCheckExpr;
exports.createCheckTableRefs = createCheckTableRefs;
exports.createCheckConstraintBuilder = createCheckConstraintBuilder;
exports.createConstraintBuilder = createConstraintBuilder;
...
function createCheckConstraintBuilder() {
    return {
        ...
        constraint(name, condition) {
            return withCheckId({ name, expression: condition.$sql });
        },
        raw(expression) {
...
function withCheckId(def) {
    return {
        ...def,
        $id(trackingId) {
            return withCheckId({ ...def, $trackingId: trackingId });
        },
    };
}
function withConstraintId(def) {
    return {
        ...def,
        $id(trackingId) {
            return withConstraintId({ ...def, $trackingId: trackingId });
        },
    };
}
