import { parseCreateTable } from "./sql-parser.js";
...
export function formatDefaultValue(value, colType) {
...
export function introspectSQL(sql, importPath) {
    const parsed = parseCreateTable(sql);
    const code = generateSchemaCode(parsed, { importPath });
    return { parsed, code };
}
export function introspectMultiple(sql, importPath) {
