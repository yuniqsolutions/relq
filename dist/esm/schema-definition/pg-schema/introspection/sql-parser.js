import { SQL_TYPE_MAP, parseIdentifier, RelqQueryError } from "./introspection-types.js";
...
export function parseColumnDefinition(columnDef) {
...
export function parseTableConstraint(constraintDef) {
...
export function splitTableBody(body) {
    const results = [];
    let current = '';
    let parenDepth = 0;
    let inString = false;
