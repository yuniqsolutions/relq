...
export const DSQL_LIMIT_WARNINGS = {
    'DSQL-LIMIT-001': {
        code: 'DSQL-LIMIT-001',
        severity: 'warning',
...
export const DSQL_IDX_LIMIT_RULES = {
    'DSQL-IDX-LIMIT-001': {
...
export const DSQL_ALL_RULES = {
    ...DSQL_TYPE_ERRORS,
    ...DSQL_LIMIT_WARNINGS,
    ...DSQL_MOD_ERRORS,
    ...DSQL_CONS_RULES,
    ...DSQL_IDX_RULES,
    ...DSQL_IDX_LIMIT_RULES,
    ...DSQL_TBL_RULES,
    ...DSQL_FN_RULES,
    ...DSQL_TRIG_RULES,
    ...DSQL_VIEW_RULES,
...
export function createDsqlValidationResult(messages) {
...
export function lookupDsqlRule(code) {
    return DSQL_ALL_RULES[code];
}
export function createDsqlMessage(code, location) {
    const def = DSQL_ALL_RULES[code];
    if (!def) {
        return {
            code,
            severity: 'error',
...
export function formatDsqlMessage(msg) {
...
export function formatDsqlValidationResult(result) {
    const lines = [];
