...
export function validateSqlForCrdb(sql, location) {
    const errors = [];
...
export function validateSchemaForCrdb(schema) {
    const errors = [];
    const warnings = [];
    ...
    warnings.push({
        ...
        message: TRANSACTION_NOTES.RETRY_REQUIRED,
...
export function formatCrdbErrors(result) {
    const lines = [];
...
export function hasCrdbIncompatibilities(sql) {
