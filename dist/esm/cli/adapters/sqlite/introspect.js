import { SQLITE_TYPE_AFFINITY } from "./features.js";
export async function introspectSQLite(executeQuery, databaseName, options) {
    const schema = {
...
function getTypeAffinity(type) {
    ...
    if (SQLITE_TYPE_AFFINITY[lowerType]) {
        return SQLITE_TYPE_AFFINITY[lowerType];
    }
...
export async function listTables(executeQuery) {
...
export async function getSQLiteVersion(executeQuery) {
