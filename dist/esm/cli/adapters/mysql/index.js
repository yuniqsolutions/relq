import { MYSQL_FEATURES, POSTGRES_TO_MYSQL_TYPE_MAP, MYSQL_TO_POSTGRES_TYPE_MAP } from "./features.js";
...
export class MySQLAdapter {
    ...
    async introspect(connection, options) {
        ...
        try {
            ...
            return await introspectMySQL(executeQuery, databaseName, options);
        }
        finally {
            await conn.end();
        }
    ...
    mapTypeToFriendly(internalType) {
        ...
        return MYSQL_TO_POSTGRES_TYPE_MAP[type] || internalType;
    }
    mapTypeToInternal(friendlyType) {
        const type = friendlyType.toLowerCase();
        return POSTGRES_TO_MYSQL_TYPE_MAP[type] || friendlyType;
    }
...
export { MYSQL_FEATURES } from "./features.js";
